...
var SYSTEM_PROMPT = `Eres JARVIS, el asistente virtual oficial de Algorixis Innova (INNOVA). 
...
var POST = async ({ request }) => {
	try {
		...
		const apiKey = "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";
